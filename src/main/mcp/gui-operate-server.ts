...
// - macOS: ~/Library/Application Support/ai-ierp
// - Windows: %APPDATA%/ai-ierp
const OPEN_COWORK_DATA_DIR =
  PLATFORM === 'win32'
    ? path.join(process.env.APPDATA || path.join(os.homedir(), 'AppData', 'Roaming'), 'ai-ierp')
    : path.join(os.homedir(), 'Library', 'Application Support', 'ai-ierp');

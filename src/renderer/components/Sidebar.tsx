      ...
      <div className="px-4 pt-5 pb-4 border-b border-border-muted">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex items-center gap-3">
            <img
              src={logoUrl}
              alt={t('common.appLogoAlt', { appName })}
              className="w-10 h-10 rounded-2xl object-contain border border-border-subtle bg-background/60 flex-shrink-0 p-0.5"
            />
            <div className="min-w-0">
              <h1 className="text-[1.34rem] leading-none font-semibold tracking-[-0.035em] text-text-primary truncate">
                {appName}
              </h1>
            </div>
          </div>

...
export interface Session {
  ...
  model?: string;
  /**
   * MCP server ids explicitly turned OFF for this chat. Empty/undefined means
   * all connected MCP servers are available. Stored as an exclude list so newly
   * added servers are active by default.
   */
...
export interface AppConfig {
  ...
  enableThinking?: boolean;
  /** Model response inactivity timeout in minutes (1–60). Default 10. */
